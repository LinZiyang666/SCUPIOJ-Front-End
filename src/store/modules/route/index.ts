...
import type { CustomRoute, ElegantConstRoute, RouteKey, RouteMap } from '@elegant-router/types';
import { SetupStoreId } from '@/enum';
import { router } from '@/router';
import { ROOT_ROUTE, createRoutes, getAuthVueRoutes } from '@/router/routes';
import { getRouteName, getRoutePath } from '@/router/routes/transform';
...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
   ...
   */
  function setRouteHome(routeKey: any) {
  ...
  /** Global breadcrumbs */
  const breadcrumbs: any = computed(() => getBreadcrumbsByRoute(router.currentRoute.value, menus.value));
   ...
   */
  function handleAuthRoutes(routes: any[]) {
   ...
   */
  function handleUpdateRootRouteRedirect(redirectKey: any) {
